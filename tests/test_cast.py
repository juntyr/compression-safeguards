...
def test_nextafter_float128():
    ...
    # assert _nextafter(np.array(_float128(1)), np.inf)[()] == _float128('1.0000000000000000000000000000000002')
    ...
    # assert _nextafter(np.array(_float128('1.0000000000000000000000000000000004')), np.inf)[()] == _float128('1.0000000000000000000000000000000006')
    # assert _nextafter(np.array(_float128('1.0000000000000000000000000000000004')), -np.inf)[()] == _float128('1.0000000000000000000000000000000002')
    # assert _nextafter(np.array(_float128('-1.0000000000000000000000000000000004')), np.inf)[()] == _float128('-1.0000000000000000000000000000000002')
    # assert _nextafter(np.array(_float128('-1.0000000000000000000000000000000004')), -np.inf)[()] == _float128('-1.0000000000000000000000000000000006')
