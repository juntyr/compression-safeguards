...
<script>
  window.addEventListener("load", () => {
    ...
    document.getElementById("try-notebook-jupyterlite").src = "https://lab.climet.eu/v0.4.2/notebooks/index.html?kernel=python&fromURL=" + notebook.href + "&pyodideKernelEnv=" + encodeURIComponent(JSON.stringify({"$override": {
